     ...
     <!-- php code for coperative registeration: -->
        ...
        <?php
            ...
            if (isset($_POST["submit"])) {
                ...
                register_client($_POST["firstname"]."-".$_POST["lastname"],$_POST["email"],$_POST["password"]);
                            ...
                            <form action="#" method="POST" class="user">
                                ...
                                <div class="form-group">
                                    <input type="email" name="email" class="form-control form-control-user" id="exampleInputEmail"
                                        placeholder="Email Address" onchange="showHint(this.value);" required>
    ...
    <script>
        function showHint(str) {
            if (str.length == 0) {
                ...
                xmlhttp.open("GET", "admin/create-acount/ajax-email.php?email="+str, true);
                xmlhttp.send();
            }
        }
    </script>
